					...
					<div className='drink-info-wrapper'>
						...
						<div className='ingredients-wrapper'>
							...
							<ul className='zutaten-liste'>
								...
								<li>
									<p>{props.strMeasure4}</p>{" "}
									<p>{props.strIngredient4}</p>
								</li>
								<li>
									<p>{props.strMeasure5}</p>{" "}
									<p>{props.strIngredient5}</p>
								</li>
								<li>
									<p>{props.strMeasure6}</p>{" "}
									<p>{props.strIngredient6}</p>
								</li>
								<li>
									<p>{props.strMeasure7}</p>{" "}
									<p>{props.strIngredient7}</p>
								</li>
								<li>
									<p>{props.strMeasure8}</p>{" "}
									<p>{props.strIngredient8}</p>
								</li>
								<li>
									<p>{props.strMeasure9}</p>{" "}
									<p>{props.strIngredient9}</p>
								</li>
								<li>
									<p>{props.strMeasure10}</p>{" "}
									<p>{props.strIngredient10}</p>
								</li>
								<li>
									<p>{props.strMeasure11}</p>{" "}
									<p>{props.strIngredient11}</p>
								</li>
								<li>
									<p>{props.strMeasure12}</p>{" "}
									<p>{props.strIngredient12}</p>
								</li>
								<li>
									<p>{props.strMeasure13}</p>{" "}
									<p>{props.strIngredient13}</p>
								</li>
								<li>
									<p>{props.strMeasure14}</p>{" "}
									<p>{props.strIngredient14}</p>
								</li>
								<li>
									<p>{props.strMeasure15}</p>{" "}
									<p>{props.strIngredient15}</p>
								</li>
							</ul>
						</div>
